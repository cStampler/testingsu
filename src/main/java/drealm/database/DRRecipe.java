...
public class DRRecipe {
	...
	public static List<IRecipe> khazad = new ArrayList<>();
	...
	public static void createKhazadRecipes() {
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.khazad_dwarven_table), "XX", "YY", Character.valueOf('X'), "plankWood", Character.valueOf('Y'), new ItemStack(LOTRMod.brick, 1, 6)));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.shovel_khazad_dwarven), "X", "Y", "Y", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.pickaxe_khazad_dwarven), "XXX", " Y ", " Y ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.axe_khazad_dwarven), "XX", "XY", " Y", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.sword_khazad_dwarven), "X", "X", "Y", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.hoe_khazad_dwarven), "XX", " Y", " Y", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.dagger_khazad_dwarven), "X", "Y", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.battleaxe_khazad_dwarven), "XXX", "XYX", " Y ", Character.valueOf('X'),LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.hammer_khazad_dwarven), "XYX", "XYX", " Y ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.helmet_khazad_dwarven), "XXX", "X X", Character.valueOf('X'), LOTRMod.dwarfSteel));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.body_khazad_dwarven), "X X", "XXX", "XXX", Character.valueOf('X'), LOTRMod.dwarfSteel));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.legs_khazad_dwarven), "XXX", "X X", "X X", Character.valueOf('X'), LOTRMod.dwarfSteel));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.boots_khazad_dwarven), "X X", "X X", Character.valueOf('X'), LOTRMod.dwarfSteel));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.throwing_axe_khazad_dwarven), " X ", " YX", "Y  ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.chandelier, 0, 8), " X ", "YZY", Character.valueOf('X'), "stickWood", Character.valueOf('Y'), Blocks.torch, Character.valueOf('Z'), LOTRMod.dwarfSteel));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.mattock_khazad_dwarven), "XXX", "XY ", " Y ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.banner, 1, DRItemBanner.KHAZAD.bannerID), "X", "Y", "Z", Character.valueOf('X'), Blocks.wool, Character.valueOf('Y'), "stickWood", Character.valueOf('Z'), "plankWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.spear_khazad_dwarven), "  X", " Y ", "Y  ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.boar_armor_khazad_dwarven), "X  ", "XYX", "XXX", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), Items.leather));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.pike_khazad_dwarven), "  X", " YX", "Y  ", Character.valueOf('X'), LOTRMod.dwarfSteel, Character.valueOf('Y'), "stickWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.gateKhazad, 4), "ZYZ", "YXY", "ZYZ", Character.valueOf('X'), LOTRMod.gateGear, Character.valueOf('Y'), new ItemStack(DRRegistry.brick, 1, 2), Character.valueOf('Z'), LOTRMod.dwarfSteel));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.mechanism), " X ", "YZY", " X ", Character.valueOf('X'), "ingotCopper", Character.valueOf('Y'), Items.flint, Character.valueOf('Z'), LOTRMod.dwarfSteel));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.brick, 4, 2), "XX", "XX", Character.valueOf('X'), Blocks.stone));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.slab_single, 6, 1), "XXX", Character.valueOf('X'), new ItemStack(DRRegistry.brick,2)));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.wall, 6, 1), "XXX", "XXX", Character.valueOf('X'), new ItemStack(DRRegistry.brick,2)));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.pillar, 3, 1), "X", "X", "X", Character.valueOf('X'), Blocks.stone));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenForge), "XXX", "X X", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 6)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle2, 6, 0), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.pillar, 1, 0)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenDoor), "XX", "XX", "XX", Character.valueOf('X'), Blocks.stone));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenDoorIthildin), "XX", "XY", "XX", Character.valueOf('X'), Blocks.stone, Character.valueOf('Y'), new ItemStack(LOTRMod.ithildin, 1, 0)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.dwarvenBedItem), "XXX", "YYY", Character.valueOf('X'), Blocks.wool, Character.valueOf('Y'), "plankWood"));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 1, 8), " X ", "XYX", " X ", Character.valueOf('X'), "nuggetSilver", Character.valueOf('Y'), new ItemStack(LOTRMod.brick, 1, 6)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 1, 9), " X ", "XYX", " X ", Character.valueOf('X'), "nuggetGold", Character.valueOf('Y'), new ItemStack(LOTRMod.brick, 1, 6)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick, 1, 10), " X ", "XYX", " X ", Character.valueOf('X'), LOTRMod.mithrilNugget, Character.valueOf('Y'), new ItemStack(LOTRMod.brick, 1, 6)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick2, 1, 12), "XX", "XX", Character.valueOf('X'), new ItemStack(LOTRMod.brick, 1, 6)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick3, 1, 12), " X ", "XYX", " X ", Character.valueOf('X'), Items.glowstone_dust, Character.valueOf('Y'), new ItemStack(LOTRMod.brick, 1, 6)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsDwarvenBrickCracked, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick4, 1, 5)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle7, 6, 6), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick4, 1, 5)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall4, 6, 5), "XXX", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick4, 1, 5)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle7, 6, 7), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.pillar2, 1, 0)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.brick4, 4, 14), "XX", "XX", Character.valueOf('X'), LOTRMod.obsidianShard));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.stairsDwarvenBrickObsidian, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick4, 1, 14)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.slabSingle8, 6, 6), "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick4, 1, 14)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.wall4, 6, 6), "XXX", "XXX", Character.valueOf('X'), new ItemStack(LOTRMod.brick4, 1, 14)));
		khazad.add(new LOTRRecipePoisonWeapon(LOTRMod.chisel, LOTRMod.chiselIthildin, new ItemStack(LOTRMod.ithildin, 1, 0)));
		khazad.add(new ShapedOreRecipe(new ItemStack(LOTRMod.ironCrossbow), "XXY", "ZYX", "YZX", Character.valueOf('X'), DRRegistry.red_dwarf_steel, Character.valueOf('Y'), "stickWood", Character.valueOf('Z'), Items.string));
		khazad.add(new ShapelessOreRecipe(new ItemStack(DRRegistry.red_dwarf_steel, 1), new ItemStack(LOTRMod.rock, 1, 4), "ingotIron"));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.khazad_stairs, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(DRRegistry.brick, 1, 2)));
		khazad.add(new ShapedOreRecipe(new ItemStack(DRRegistry.khazad_bars, 16), "XXX", "XXX", Character.valueOf('X'), LOTRMod.dwarfSteel));
	...
	public static void createUnsmeltRecipes() {
		...
		LOTRRecipes.uncraftableUnsmeltingRecipes.addAll(khazad);
	}
	...
	public static void createWindMountainsRecipes() {
		...
		wind_mountains.add(new ShapedOreRecipe(new ItemStack(DRRegistry.khazad_stairs, 4), "X  ", "XX ", "XXX", Character.valueOf('X'), new ItemStack(DRRegistry.brick, 1, 0)));
	}
