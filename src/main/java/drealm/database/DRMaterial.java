...
public class DRMaterial {
	...
	public static LOTRMaterial KHAZAD_DWARVEN = DRMaterial.newLOTRMaterial("KHAZAD", 650, 3.0f, 0.7f, 7.0f, 3, 12, null);
	...
	public static void onInit() {
		...
		DRCommander.setMaterialCraftingItem(KHAZAD_DWARVEN, LOTRMod.dwarfSteel);
	}
