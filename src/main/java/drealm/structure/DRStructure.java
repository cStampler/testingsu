...
public class DRStructure {
	...
	public static void preInit() {
		...
		DRStructure.registerStructure(id++, DRStructureKhazadMountainsHouse.class, "KhazadMountainsHouse", 0x372d25, 0x372d25);
		DRStructure.registerStructure(id++, DRStructureKhazadMountainsSmithy.class, "KhazadMountainsSmithy", 0x372d25, 0x372d25);
		DRStructure.registerStructure(id++, DRStructureKhazadMountainsStronghold.class, "KhazadMountainsStronghold", 0x372d25, 0x372d25);
	}
