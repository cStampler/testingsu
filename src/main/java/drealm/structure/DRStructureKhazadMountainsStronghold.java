...
public class DRStructureKhazadMountainsStronghold extends LOTRWorldGenStructureBase {
	public DRStructureKhazadMountainsStronghold(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k) {
		...
		for (k1 = k - 6; k1 <= k + 6; ++k1) {
			for (i1 = i - 6; i1 <= i + 6; ++i1) {
				...
				for (int j1 = j + 7; (j1 >= j || !LOTRMod.isOpaque(world, i1, j1, k1)) && j1 >= 0; --j1) {
					if (flag) {
						setBlockAndNotifyAdequately(world, i1, j1, k1, DRRegistry.pillar, 1);
					} else {
						...
						setBlockAndNotifyAdequately(world, i1, j1, k1, DRRegistry.brick, 2);
					}
					if (j1 > j) {
						continue;
					}
		...
		for (i12 = i - 6; i12 <= i + 6; ++i12) {
			setBlockAndNotifyAdequately(world, i12, j + 8, k - 6, DRRegistry.khazad_stairs, 2);
			setBlockAndNotifyAdequately(world, i12, j + 8, k + 6, DRRegistry.khazad_stairs, 3);
		}
		for (k1 = k - 6; k1 <= k + 6; ++k1) {
			setBlockAndNotifyAdequately(world, i - 6, j + 8, k1, DRRegistry.khazad_stairs, 0);
			setBlockAndNotifyAdequately(world, i + 6, j + 8, k1, DRRegistry.khazad_stairs, 1);
		}
		for (k1 = k - 5; k1 <= k + 5; ++k1) {
			for (i1 = i - 5; i1 <= i + 5; ++i1) {
				setBlockAndNotifyAdequately(world, i1, j + 4, k1, DRRegistry.slab_double, 1);
				setBlockAndNotifyAdequately(world, i1, j + 8, k1, DRRegistry.slab_double, 1);
				...
				setBlockAndNotifyAdequately(world, i1, j + 9, k1, DRRegistry.wall, 1);
			}
		}
		for (i12 = i - 5; i12 <= i + 5; ++i12) {
			setBlockAndNotifyAdequately(world, i12, j + 12, k - 5, DRRegistry.khazad_stairs, 2);
			setBlockAndNotifyAdequately(world, i12, j + 12, k + 5, DRRegistry.khazad_stairs, 3);
		}
		for (k1 = k - 5; k1 <= k + 5; ++k1) {
			setBlockAndNotifyAdequately(world, i - 5, j + 12, k1, DRRegistry.khazad_stairs, 0);
			setBlockAndNotifyAdequately(world, i + 5, j + 12, k1, DRRegistry.khazad_stairs, 1);
		}
		for (k1 = k - 4; k1 <= k + 4; ++k1) {
			for (i1 = i - 4; i1 <= i + 4; ++i1) {
				setBlockAndNotifyAdequately(world, i1, j + 12, k1, DRRegistry.slab_single, 1);
			}
		}
		setBlockAndNotifyAdequately(world, i, j + 7, k, LOTRMod.chandelier, 8);
		setBlockAndNotifyAdequately(world, i, j + 11, k, LOTRMod.chandelier, 8);
		setBlockAndNotifyAdequately(world, i, j + 12, k, DRRegistry.brick, 2);
		switch (rotation) {
			case 0: {
		...
		respawner.setSpawnClasses(DREntityKhazadDwarfWarrior.class, DREntityKhazadDwarfAxeThrower.class);
	...
	public void generateFacingEast(World world, Random random, int i, int j, int k) {
		...
		for (k12 = k - 6; k12 <= k + 6; ++k12) {
			setBlockAndNotifyAdequately(world, i - 7, j + 1, k12, DRRegistry.slab_single, 1);
			setGrassToDirt(world, i - 7, j, k12);
			for (j1 = j; !LOTRMod.isOpaque(world, i - 7, j1, k12) && j1 >= 0; --j1) {
				setBlockAndNotifyAdequately(world, i - 7, j1, k12, DRRegistry.pillar, 1);
				setGrassToDirt(world, i - 7, j1 - 1, k12);
			}
		}
		for (j12 = j + 1; j12 <= j + 2; ++j12) {
			setAir(world, i - 6, j12, k);
			setBlockAndNotifyAdequately(world, i - 7, j12, k - 1, DRRegistry.pillar, 1);
			setBlockAndNotifyAdequately(world, i - 7, j12, k + 1, DRRegistry.pillar, 1);
		}
		...
		setBlockAndNotifyAdequately(world, i - 7, j + 3, k - 1, DRRegistry.khazad_stairs, 2);
		setBlockAndNotifyAdequately(world, i - 7, j + 3, k, LOTRMod.brick3, 12);
		setBlockAndNotifyAdequately(world, i - 7, j + 3, k + 1, DRRegistry.khazad_stairs, 3);
		setBlockAndNotifyAdequately(world, i - 7, j + 4, k, DRRegistry.slab_single, 1);
		placeWallBanner(world, i - 6, j + 6, k, 1, DRItemBanner.KHAZAD);
		for (j12 = j + 1; j12 <= j + 3; ++j12) {
			for (i1 = i - 4; i1 <= i - 1; ++i1) {
				for (k13 = k - 5; k13 <= k - 1; ++k13) {
					setBlockAndNotifyAdequately(world, i1, j12, k13, DRRegistry.brick, 2);
				}
			...
			for (i1 = i - 2; i1 <= i + 5; ++i1) {
				setBlockAndNotifyAdequately(world, i1, j12, k - 1, DRRegistry.brick, 2);
				setBlockAndNotifyAdequately(world, i1, j12, k + 1, DRRegistry.brick, 2);
			}
		}
		...
		for (k12 = k - 5; k12 <= k + 2; k12 += 7) {
			...
			LOTRChestContents.fillChest(world, random, i, j + 1, k12 + 2, DRChestContents.KHAZAD_MOUNTAINS_STRONGHOLD);
			setBlockAndNotifyAdequately(world, i + 3, j + 3, k12 + 1, LOTRMod.chandelier, 8);
		...
		for (j1 = j + 1; j1 <= j + 4; ++j1) {
			...
			setAir(world, i - 5, j + 4, k + stairX);
			setBlockAndNotifyAdequately(world, i - 5, j1, k - stairX, DRRegistry.khazad_stairs, 3);
			setBlockAndNotifyAdequately(world, i - 5, j1, k + stairX, DRRegistry.khazad_stairs, 2);
			for (j2 = j1 - 1; j2 > j; --j2) {
				setBlockAndNotifyAdequately(world, i - 5, j2, k - stairX, DRRegistry.brick, 2);
				setBlockAndNotifyAdequately(world, i - 5, j2, k + stairX, DRRegistry.brick, 2);
			}
			++stairX;
		}
		for (j1 = j + 1; j1 <= j + 3; ++j1) {
			setBlockAndNotifyAdequately(world, i - 5, j1, k - stairX, DRRegistry.brick, 2);
			setBlockAndNotifyAdequately(world, i - 5, j1, k + stairX, DRRegistry.brick, 2);
		}
		for (k1 = k - 5; k1 <= k + 5; k1 += 10) {
			...
			setBlockAndNotifyAdequately(world, i + 2, j + 5, k1, Blocks.planks, 1);
			setBlockAndNotifyAdequately(world, i + 2, j + 6, k1, Blocks.wooden_slab, 1);
			setBlockAndNotifyAdequately(world, i, j + 5, k1, DRRegistry.khazad_dwarven_table, 0);
		...
		for (j1 = j + 5; j1 <= j + 8; ++j1) {
			...
			setAir(world, i - 4, j + 8, k + stairX);
			setBlockAndNotifyAdequately(world, i - 4, j1, k - stairX, DRRegistry.khazad_stairs, 2);
			setBlockAndNotifyAdequately(world, i - 4, j1, k + stairX, DRRegistry.khazad_stairs, 3);
			for (j2 = j1 - 1; j2 > j + 4; --j2) {
				setBlockAndNotifyAdequately(world, i - 4, j2, k - stairX, DRRegistry.brick, 2);
				setBlockAndNotifyAdequately(world, i - 4, j2, k + stairX, DRRegistry.brick, 2);
			}
			--stairX;
		}
		for (j1 = j + 5; j1 <= j + 7; ++j1) {
			setBlockAndNotifyAdequately(world, i - 4, j1, k, DRRegistry.brick, 2);
		}
		...
		setBlockAndNotifyAdequately(world, i + 6, j + 4, k, DRRegistry.slab_double, 1);
		...
		setBlockAndNotifyAdequately(world, i + 8, j + 3, k, LOTRMod.chandelier, 8);
	...
	public void generateFacingNorth(World world, Random random, int i, int j, int k) {
		...
		int j2;
		for (i12 = i - 6; i12 <= i + 6; ++i12) {
			setBlockAndNotifyAdequately(world, i12, j + 1, k + 7, DRRegistry.slab_single, 1);
			setGrassToDirt(world, i12, j, k + 7);
			for (j1 = j; !LOTRMod.isOpaque(world, i12, j1, k + 7) && j1 >= 0; --j1) {
				setBlockAndNotifyAdequately(world, i12, j1, k + 7, DRRegistry.pillar, 1);
				setGrassToDirt(world, i12, j1 - 1, k + 7);
			}
		}
		for (j12 = j + 1; j12 <= j + 2; ++j12) {
			setAir(world, i, j12, k + 6);
			setBlockAndNotifyAdequately(world, i - 1, j12, k + 7, DRRegistry.pillar, 1);
			setBlockAndNotifyAdequately(world, i + 1, j12, k + 7, DRRegistry.pillar, 1);
		}
		...
		setBlockAndNotifyAdequately(world, i - 1, j + 3, k + 7, DRRegistry.khazad_stairs, 0);
		setBlockAndNotifyAdequately(world, i, j + 3, k + 7, LOTRMod.brick3, 12);
		setBlockAndNotifyAdequately(world, i + 1, j + 3, k + 7, DRRegistry.khazad_stairs, 1);
		setBlockAndNotifyAdequately(world, i, j + 4, k + 7, DRRegistry.slab_single, 1);
		placeWallBanner(world, i, j + 6, k + 6, 0, DRItemBanner.KHAZAD);
		for (j12 = j + 1; j12 <= j + 3; ++j12) {
			for (k1 = k + 4; k1 >= k + 1; --k1) {
				for (i1 = i - 5; i1 <= i - 1; ++i1) {
					setBlockAndNotifyAdequately(world, i1, j12, k1, DRRegistry.brick, 2);
				}
			...
			for (k1 = k + 2; k1 >= k - 5; --k1) {
				setBlockAndNotifyAdequately(world, i - 1, j12, k1, DRRegistry.brick, 2);
				setBlockAndNotifyAdequately(world, i + 1, j12, k1, DRRegistry.brick, 2);
			}
		}
		...
		for (i12 = i - 5; i12 <= i + 2; i12 += 7) {
			...
			LOTRChestContents.fillChest(world, random, i12 + 2, j + 1, k, DRChestContents.KHAZAD_MOUNTAINS_STRONGHOLD);
			setBlockAndNotifyAdequately(world, i12 + 1, j + 3, k - 3, LOTRMod.chandelier, 8);
		...
		for (j1 = j + 1; j1 <= j + 4; ++j1) {
			...
			setAir(world, i + stairX, j + 4, k + 5);
			setBlockAndNotifyAdequately(world, i - stairX, j1, k + 5, DRRegistry.khazad_stairs, 1);
			setBlockAndNotifyAdequately(world, i + stairX, j1, k + 5, DRRegistry.khazad_stairs, 0);
			for (j2 = j1 - 1; j2 > j; --j2) {
				setBlockAndNotifyAdequately(world, i - stairX, j2, k + 5, DRRegistry.brick, 2);
				setBlockAndNotifyAdequately(world, i + stairX, j2, k + 5, DRRegistry.brick, 2);
			}
			++stairX;
		}
		for (j1 = j + 1; j1 <= j + 3; ++j1) {
			setBlockAndNotifyAdequately(world, i - stairX, j1, k + 5, DRRegistry.brick, 2);
			setBlockAndNotifyAdequately(world, i + stairX, j1, k + 5, DRRegistry.brick, 2);
		}
		for (i13 = i - 5; i13 <= i + 5; i13 += 10) {
			...
			setBlockAndNotifyAdequately(world, i13, j + 5, k - 2, Blocks.planks, 1);
			setBlockAndNotifyAdequately(world, i13, j + 6, k - 2, Blocks.wooden_slab, 1);
			setBlockAndNotifyAdequately(world, i13, j + 5, k, DRRegistry.khazad_dwarven_table, 0);
		...
		for (j1 = j + 5; j1 <= j + 8; ++j1) {
			...
			setAir(world, i + stairX, j + 8, k + 4);
			setBlockAndNotifyAdequately(world, i - stairX, j1, k + 4, DRRegistry.khazad_stairs, 0);
			setBlockAndNotifyAdequately(world, i + stairX, j1, k + 4, DRRegistry.khazad_stairs, 1);
			for (j2 = j1 - 1; j2 > j + 4; --j2) {
				setBlockAndNotifyAdequately(world, i - stairX, j2, k + 4, DRRegistry.brick, 2);
				setBlockAndNotifyAdequately(world, i + stairX, j2, k + 4, DRRegistry.brick, 2);
			}
			--stairX;
		}
		for (j1 = j + 5; j1 <= j + 7; ++j1) {
			setBlockAndNotifyAdequately(world, i, j1, k + 4, DRRegistry.brick, 2);
		}
		...
		setBlockAndNotifyAdequately(world, i, j + 4, k - 6, DRRegistry.slab_double, 1);
		...
		setBlockAndNotifyAdequately(world, i, j + 3, k - 8, LOTRMod.chandelier, 8);
		for (j1 = j + 1; j1 <= j + 2; ++j1) {
	...
	public void generateFacingSouth(World world, Random random, int i, int j, int k) {
		...
		setBlockAndNotifyAdequately(world, i + 1, j + 3, k - 7, DRRegistry.khazad_stairs, 1);
		setBlockAndNotifyAdequately(world, i, j + 4, k - 7, DRRegistry.slab_single, 1);
		placeWallBanner(world, i, j + 6, k - 6, 2, DRItemBanner.KHAZAD);
		for (j12 = j + 1; j12 <= j + 3; ++j12) {
			for (k1 = k - 4; k1 <= k - 1; ++k1) {
				for (i1 = i - 5; i1 <= i - 1; ++i1) {
					setBlockAndNotifyAdequately(world, i1, j12, k1, DRRegistry.brick, 2);
	...
	public void generateFacingWest(World world, Random random, int i, int j, int k) {
		...
		setBlockAndNotifyAdequately(world, i + 7, j + 3, k + 1, DRRegistry.khazad_stairs, 3);
		setBlockAndNotifyAdequately(world, i + 7, j + 4, k, DRRegistry.slab_single, 1);
		placeWallBanner(world, i + 6, j + 6, k, 3, DRItemBanner.KHAZAD);
		for (j12 = j + 1; j12 <= j + 3; ++j12) {
			for (i1 = i + 4; i1 >= i + 1; --i1) {
				for (k13 = k - 5; k13 <= k - 1; ++k13) {
					setBlockAndNotifyAdequately(world, i1, j12, k13, DRRegistry.brick, 2);
	...
	public void placeBalconySection(World world, int i, int j, int k, boolean isEdge, boolean isPillar) {
		if (isEdge) {
			for (int j1 = j + 4; (j1 >= j || !LOTRMod.isOpaque(world, i, j1, k)) && j1 >= 0; --j1) {
				if (isPillar) {
					setBlockAndNotifyAdequately(world, i, j1, k, DRRegistry.pillar, 1);
				} else {
					setBlockAndNotifyAdequately(world, i, j1, k, DRRegistry.brick, 2);
				}
			...
			setBlockAndNotifyAdequately(world, i, j + 5, k, DRRegistry.brick, 2);
			setBlockAndNotifyAdequately(world, i, j + 6, k, DRRegistry.wall, 1);
		} else {
			int j1;
			...
			setBlockAndNotifyAdequately(world, i, j + 4, k, DRRegistry.slab_double, 1);
		}
	}
	...
	public static void spawnDwarf(World world, int i, int j, int k) {
		DREntityKhazadDwarfWarrior dwarf = world.rand.nextInt(3) == 0 ? new DREntityKhazadDwarfAxeThrower(world) : new DREntityKhazadDwarfWarrior(world);
		dwarf.setLocationAndAngles(i + 0.5, j, k + 0.5, 0.0f, 0.0f);
		((DREntityKhazadDwarf) dwarf).onSpawnWithEgg(null);
	...
	public static void spawnDwarfCommander(World world, int i, int j, int k) {
		DREntityKhazadDwarfCommander dwarf = new DREntityKhazadDwarfCommander(world);
		dwarf.setLocationAndAngles(i + 0.5, j, k + 0.5, 0.0f, 0.0f);
