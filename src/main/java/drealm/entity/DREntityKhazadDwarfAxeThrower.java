...
public class DREntityKhazadDwarfAxeThrower extends DREntityKhazadDwarfWarrior {
	public DREntityKhazadDwarfAxeThrower(World world) {
		super(world);
	}
	...
	public void attackEntityWithRangedAttack(EntityLivingBase target, float f) {
		...
		if (axeItem == null) {
			axeItem = new ItemStack(DRRegistry.throwing_axe_red_dwarven);
		}
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
		...
		npcItemsInv.setRangedWeapon(new ItemStack(DRRegistry.throwing_axe_khazad_dwarven));
